...
export declare const isObjectId: (id: string | mongoose.Types.ObjectId) => boolean;
export declare const toObjectId: (id: string | mongoose.Types.ObjectId) => mongoose.Types.ObjectId;
export declare const toPosixPath: (str: string) => string;
