...
export declare class PerformerBlockController {
    ...
    performerBlockCountries(payload: PerformerBlockCountriesPayload, user: UserDto): Promise<DataResponse<import("mongoose").Document<unknown, {}, import("../models").PerformerBlockCountryModel> & Omit<import("../models").PerformerBlockCountryModel & {
