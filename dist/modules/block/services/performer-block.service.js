...
let PerformerBlockService = class PerformerBlockService {
    ...
    async getBlockedUsers(user, req) {
        ...
        const targetIds = (0, lodash_1.uniq)(data.map((d) => d.targetId));
...
PerformerBlockService = __decorate([
    ...
    __param(1, (0, common_1.Inject)(providers_1.PERFORMER_BLOCK_COUNTRY_PROVIDER)),
    __param(2, (0, common_1.Inject)(providers_1.PERFORMER_BLOCK_USER_PROVIDER)),
