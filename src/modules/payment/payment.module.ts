...
import { Pay2mService } from "./services/pay2m.service";
...
@Module({
  ...
  exports: [...paymentProviders, PaymentService, PaymentSearchService],
})
export class PaymentModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer.apply(RequestLoggerMiddleware).forRoutes("/payment/*/callhook");
  }
}
